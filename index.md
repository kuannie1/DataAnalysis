...
This is an example of one of the graphs that our tool can output when the inputs ‘BP’, ‘2010-02-02', and ‘2010-12-31' are entered into the interactive_scatter_plot.py function as the company name, start date, and end date. 